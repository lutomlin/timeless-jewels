...
// Node positions in world space, computed once at load. The orbit maths is pure
// trig over data that never changes, so doing it per node per frame was the
// single biggest cost in the render loop.
